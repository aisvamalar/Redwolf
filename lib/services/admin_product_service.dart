...
class AdminProductService {
  ...
  List<AdminProduct> _cachedProducts = [];
  ...
  Future<List<AdminProduct>> getProducts({bool forceRefresh = false}) async {
  ...
  List<AdminProduct> getCachedProducts() {
    return List.from(_cachedProducts);
  }
  ...
  Future<String?> addProduct(AdminProduct product) async {
    try {
      ...
      if (productId != null) {
        final newProduct = AdminProduct.fromJson(response);
  ...
  Future<String?> duplicateProduct(AdminProduct product) async {
    try {
  ...
  Future<bool> updateProduct(String id, AdminProduct product) async {
    try {
      ...
      final updatedProduct = AdminProduct.fromJson(response);
